...
namespace WPFTest.Migrations
{
    ...
    [Migration("20250309093720_AddCategoryTypes")]
            ...
            modelBuilder.Entity("WPFTest.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 9, 10, 37, 19, 908, DateTimeKind.Local).AddTicks(1443),
                            Email = "admin@example.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$rZ60kMgN4yoAu7wURgMqLefVek0D/eQheU.die5B8iD9dVfGfKiWO",
                            Role = "Administrator",
                            Username = "admin"
                        });
                });
